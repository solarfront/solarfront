...
export interface UnitUpdate {
  ...
  constructionProgress?: number; // 0-1, progress of construction
  portQueueUnitType?: UnitType; // Only for ports with active queue
  portQueueProgress?: number; // 0-1, progress of port queue
}
