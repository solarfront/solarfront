export class UserSettings {
  ...
  soundEffectsEnabled() {
    return this.get("settings.soundEffects", true);
  }

  musicEnabled() {
    return this.get("settings.music", true);
  }
  ...
  toggleSoundEffects() {
    this.set("settings.soundEffects", !this.soundEffectsEnabled());
  }

  toggleMusic() {
    this.set("settings.music", !this.musicEnabled());
  }
}
