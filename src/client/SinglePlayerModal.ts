...
export class SinglePlayerModal extends LitElement {
          ...
          <div class="options-section">
            ...
            >
              ${[
                ...
                [UnitType.Viper, "unit_type.warship"],
  ...
  private getRandomMap(): GameMapType {
    // Only allow Space2 and FacingWorlds for random selection
    const maps = [GameMapType.Space2, GameMapType.FacingWorlds];
  ...
  private startGame() {
    ...
    const flagInput = document.querySelector("avatar-input") as FlagInput;
    if (!flagInput) {
