/*
// ORIGINAL MULTI-TAB DETECTION CODE - SAVED FOR LATER USE
// To re-enable: uncomment this block and comment out the no-op implementation below
...
// TEMPORARY DISABLED: Multi-tabbing detection commented out for now
// To re-enable, uncomment the above code block
export class MultiTabDetector {
  constructor() {
    // No-op constructor
  }
  ...
  public startMonitoring(startPenalty: (duration: number) => void): void {
    // No-op - multi-tabbing detection disabled
  }
