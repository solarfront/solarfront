...
export class NameLayer implements Layer {
  ...
  private createPlayerElement(player: PlayerView): HTMLDivElement {
    ...
    if (player.flag()) {
      ...
      flagImg.style.aspectRatio = "1/1";
      flagImg.style.width = "1em";
      flagImg.style.height = "1em";
      flagImg.style.marginRight = "0.25em";
  ...
  renderPlayerInfo(render: RenderInfo) {
    ...
    if (flagDiv) {
      ...
      flagDiv.style.width = `${render.fontSize}px`;
      flagDiv.style.display = "inline-block";
      flagDiv.style.verticalAlign = "middle";
    }
