...
// import mirvIcon from "../../../../resources/images/MIRVIcon.svg"; // World-Breakers disabled
...
const buildTable: BuildItemDisplay[][] = [
  [
    ...
    // Commented out World-Breakers for this build
    // {
    ...
    {
      unitType: UnitType.Condor,
      icon: condorIcon,
      description: "build_menu.desc.viper2",
      key: "unit_type.viper2",
      countable: true,
    },
    {
    ...
    {
      unitType: UnitType.OrbitalCannon,
      icon: orbitalCannonIcon,
      description: "build_menu.desc.orbital_cannon",
      key: "unit_type.orbital_cannon",
      countable: true,
    },
    {
